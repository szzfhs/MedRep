...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">MedPro-Vue3-FastAPI</h1>
...
MedPro-Vue3-FastAPI是一套全部开源的快速开发平台，毫无保留给个人及企业免费使用。
...
移动端详细文档请参考：[medpro-fastapi-app/README.md](./medpro-fastapi-app/README.md)
