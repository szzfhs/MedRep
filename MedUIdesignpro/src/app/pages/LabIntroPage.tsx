    ...
    <div className="min-h-screen bg-[#F0F4F8]">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1617246610501-d11b4829436b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920"
            alt="Lab Center"
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-2xl overflow-hidden h-52 col-span-2">
                <img src="https://images.unsplash.com/photo-1774277602359-d5dfed73aa98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800" alt="Lab" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl overflow-hidden h-36">
                <img src="https://images.unsplash.com/photo-1743767588158-72174d1898a9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400" alt="VR Lab" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl overflow-hidden h-36">
                <img src="https://images.unsplash.com/photo-1658555012297-edb48f0c2d4c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400" alt="Digital" className="w-full h-full object-cover" />
              </div>
            </div>
          </motion.div>
        </section>
