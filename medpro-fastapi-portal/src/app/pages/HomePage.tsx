...
const STATS_TEMPLATE = [
  { label: '虚拟实验项目', key: 'experimentCount' as const, unit: '个', icon: FlaskConical, color: '#0B5394', bg: '#E3F2FD' },
  { label: '实验课程',     key: 'courseCount'     as const, unit: '门', icon: BookOpen,     color: '#00897B', bg: '#E0F2F1' },
  { label: '注册用户',     key: 'userCount'       as const, unit: '人', icon: Users,        color: '#6A1B9A', bg: '#F3E5F5' },
  { label: '实验总学时',   key: 'totalDuration'   as const, unit: '时', icon: Clock,        color: '#E65100', bg: '#FFF3E0' },
];
