...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',              '平台通用大学',         0, '张老师', '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',          '平台通用大学教学部',   1, '张老师', '15888888888', 'zhang@qq.com',    '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',          '平台通用大学附属医院', 2, '张老师', '15888888888', 'zhang@qq.com',    '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',      '住培教育部',           1, '焦老师', '15888888888', 'jiao@qq.com',     '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',      '研究生教育部',         2, '年糕',   '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',      '本科教育部',           3, '年糕',   '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',      '临床技能中心',         4, '年糕',   '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',      '口腔教学实验中心',     5, '年糕',   '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',      '内科',                 2, '年糕',   '15888888888', 'niangao@qq.com',  '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(200,  0,   '0',              '杭州师范大学',         0, null,     null,          null,              '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_user values(100, 101, 'teacher01',  'teacher01',  '00', 'teacher01@qq.com',   '15888888889', '0', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '示例教师');
insert into sys_user values(101, 101, 'student01',  'student01',  '00', 'student01@qq.com',   '15888888883', '0', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '示例学生');
insert into sys_user values(102, 200, 'hzsf_admin', '杭大管理员', '00', 'admin@hznu.edu.cn',  '',            '0', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '杭州师范大学管理员');
...
-- 初始化-岗位信息表数据
-- ----------------------------
insert into sys_post values(1, 'ceo',  '院长',     1, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(2, 'se',   '专业主任', 2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'ta',   '教师',     3, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(4, 'stu',  '学生',     4, '0', 'admin', sysdate(), '', null, '');
...
create table sys_role (
  ...
  remark               varchar(500)    default null               comment '备注',
  primary key (role_id)
) engine=innodb auto_increment=200 comment = '角色信息表';
...
insert into sys_role values('100', '教师',         'teacher',     0, 1, 1, 1, '0', '0', 'admin', sysdate(), '', null, '教师角色');
insert into sys_role values('101', '学生',         'student',     0, 1, 1, 1, '0', '0', 'admin', sysdate(), '', null, '学生角色');
insert into sys_role values('102', 'SimHub管理员', 'simhub_admin',5, 1, 1, 1, '0', '0', 'admin', sysdate(), '', null, 'SimHub管理员');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2025-07-01 medPro新版本发布啦', '2', '<p>新版本内容</p>', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2025-07-01 medpro系统凌晨维护',  '1', '<p>维护内容</p>',   '0', 'admin', sysdate(), '', null, '管理员');
