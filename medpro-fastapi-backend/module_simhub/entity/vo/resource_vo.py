...
class ResourceModel(BaseModel):
    ...
    resource_content: str | None = Field(default=None, description='资源内容描述')
    file_format: str | None = Field(default=None, description='文件格式(pdf/mp4/docx等)')
    resource_type: str | None = Field(default=None, description='类型(courseware/lesson_plan/micro_video/ebook/extension)')
    ...
    course_id: int | None = Field(default=None, description='关联课程ID（旧字段）')
    section_id: int | None = Field(default=None, description='关联章节ID（旧字段）')
...
class AddResourceModel(BaseModel):
    ...
    resource_content: str | None = Field(default=None, description='资源内容描述')
    file_format: str | None = Field(default=None, description='文件格式(pdf/mp4/docx等)')
    resource_type: str | None = Field(default='courseware', description='类型(courseware/lesson_plan/micro_video/ebook/extension)')
    file_url: str | None = Field(default=None, description='文件URL')
    cover_image: str | None = Field(default=None, description='封面图URL')
    description: str | None = Field(default=None, description='描述')
